...
const DOptionCard = ({ isCardActive, cardOption, onClick }) => {
  return (
    <div className={`border rounded-md bg-white sm:py-7 py-5 px-4 md:px-10 text-center w-full cursor-pointer ${isCardActive ? 'shadow border-app-zeus-purple' : ''}`} style={{ maxWidth: '200px' }} onClick={onClick}>
